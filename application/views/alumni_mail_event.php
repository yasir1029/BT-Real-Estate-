        ...
        <div class="row">
            <div class="col-lg-8 m-auto text-center">
                <div class="page-title-content">
                    <h1 class="h2">Send Invitation for an event</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 m-auto">
                                <div class="contact-form-wrap">
                                  <h3>send message</h3>
                                    <form method="post" action="<?php echo base_url(); ?>alumni/send" enctype="form-data">
									<?php form_hidden('event_id',$event->id);  ?>
                                        <div class="row">
                                          ...
                                          <div class="col">
                                            <div class="form-group">
                                              ...
                                              <input type="email"  required id="cbxemail" <?php echo form_input([ 'name'=>'e_mail','class'=>'form-control']);?>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="text"  id="cbxsubject" <?php echo form_input([ 'name'=>'e_name','class'=>'form-control','placeholder'=>'example Event Subject goes here', 'value'=>'You are Invited to - '.$event->e_name]);?>
                                        </div>
