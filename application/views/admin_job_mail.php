				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-dark">Job Application</h5>
						</div>
						...
						<div class="col-md-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Send Invitation Message for this Job To the Relevant Alumni.</h6>
									</div>
								...
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
									    ...
									    <div class="panel-body">
										<div class="form-wrap">
											 <form method="post" action="<?php echo base_url(); ?>admin_mail/job_send" enctype="form-data">
												...
												<div class="form-group">
													...
													<input <?php echo form_input([ 'name'=>'j_name','class'=>'form-control','placeholder'=>'example Event Name goes here', 'value'=>'Job Application -  '.$job->j_name]);?>
												</div>
												<div class="form-group">
													<label class="control-label mb-10 text-left">Message Body</label>
													<textarea <?php echo form_textarea([ 'name'=>'j_desc','rows'=>'12','class'=>'form-control', 'value'=>$job->j_desc]);?></textarea>
												</div>
