														...
														<div class="modal-dialog">
															<div class="modal-content">
																...
																<div class="modal-body">
																	<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>admin_mail/compose" enctype="form-data">
																		<div class="form-group">
																			<label class="col-lg-2 control-label">To</label>
																			<div class="col-lg-10">
																				<input name="email" type="text" placeholder="" id="inputEmail1" class="form-control">
																			</div>
																		</div>
																		...
																		<div class="form-group">
																			...
																			<div class="col-lg-10">
																				<textarea name="body" class="textarea_editor form-control" rows="15" placeholder="Enter text ..."></textarea>
																			</div>
																		</div>
																		<div class="form-group">
