    ...
    <div class="wrapper  theme-1-active pimary-color-blue">
		...
		<div class="fixed-sidebar-left">
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					<a class="active" href="widgets.html"><div class="pull-left"><i class="zmdi zmdi-flag mr-20"></i><span class="right-nav-text">widgets</span></div><div class="pull-right"><span class="label label-success">8</span></div><div class="clearfix"></div></a>
				</li>
				...
				<div class="row">
					...
					<div class="col-lg-5 col-md-6 col-xs-12">
						<div class="panel panel-default card-view panel-refresh">
							...
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">top 4 products</h6>
								</div>
								<div class="clearfix"></div>
							</div>
							<div class="panel-wrapper collapse in">
								<div class="panel-body row">
									...
									<div class="col-sm-6 pr-0 pt-25">
										<div class="label-chatrs">
											...
											<div class="mb-5">
												<span class="clabels inline-block bg-danger mr-5"></span>
