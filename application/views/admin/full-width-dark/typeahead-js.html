				...
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						...
						<ul id="form_dr" class="collapse collapse-level-1 two-col-list">
							...
							<li>
								<a class="active-page" href="typeahead-js.html">typeahead</a>
							</li>
						</ul>
					</li>
					<li>
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">typeahead</h5>
						</div>
						<!-- Breadcrumb -->
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							...
							<li class="active"><span>typeahead</span></li>
						  </ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
						...
						<div class="col-sm-12">
						    <div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Typeahead.js</h6>
									</div>
									<div class="clearfix"></div>
								</div>
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<p class="text-muted">Typeahead.js examples</p>
										<form>
											<div class="form-wrap mt-40">
												<div class="row">
													<div class="col-sm-6">
														<div class="form-group">
															<label class="label-control mb-10">Basic</label>
															<div id="the-basics">
													...
													<div class="col-sm-6">
														<div class="form-group">
															<label class="label-control mb-10">BloodSnoopy</label>
															<div id="bloodSnoopy">
															  <input class="typeahead form-control" type="text" placeholder="States of USA">
															</div>
														</div>	
												...
												<div class="row">
													<div class="col-sm-6">
														<div class="form-group">
															<label class="label-control mb-10">Prefetch</label>
															<div id="prefetch">
													...
													<div class="col-sm-6">
														<div class="form-group">
															<label class="label-control mb-10">Default Suggestions</label>
