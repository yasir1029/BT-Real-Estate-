								...
								<ul class="pa-20">
									...
									<li class="col-md-6 col-xs-12 preview-carousel">
										...
										<div class="product-carousel owl-carousel owl-theme text-center">
											<a href="#">
												<img src="<?php echo base_url('assets/snoopy/img/chair.jpg');?>" alt="chair">
												<span>Circle chair</span>
											</a>
											<a href="#">
												<img src="<?php echo base_url('assets/snoopy/img/chair2.jpg');?>" alt="chair">
												<span>square chair</span>
											</a>
											<a href="#">
												<img src="<?php echo base_url('assets/snoopy/img/chair3.jpg');?>" alt="chair">
												<span>semi circle chair</span>
											</a>
											<a href="#">
												<img src="<?php echo base_url('assets/snoopy/img/chair4.jpg');?>" alt="chair">
			...
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					...
					<ul id="dashboard_dr" class="collapse collapse-level-1">
						...
						<li>
							<a  class="active-page" href="index2.html">Demographic</a>
						</li>
						<li>
							<a href="index3.html">Project</a>
						</li>
